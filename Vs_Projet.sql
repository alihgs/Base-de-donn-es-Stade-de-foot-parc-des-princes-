...
INSERT INTO PersonnelStade VALUES (4, 'Dubois', 'Marie', 'Responsable des installations', 4);
INSERT INTO PersonnelStade VALUES (5, 'Leroy', 'Philippe', 'Responsable de la billetterie', 5);
INSERT INTO PersonnelStade VALUES (6, 'Moreau', 'Isabelle', 'Coordinateur des événements', 6);
INSERT INTO PersonnelStade VALUES (7, 'Lefevre', 'François', 'Technicien son et lumière', 7);
...
INSERT INTO PersonnelStade VALUES (10, 'Martin', 'Julie', 'Responsable des médias', 10);
INSERT INTO PersonnelStade VALUES (11, 'Thomas', 'Patrick', 'Responsable des partenariats', 11);
...
INSERT INTO PersonnelStade VALUES (15, 'Roux', 'Vincent', 'Responsable de la restauration', 15);
...
INSERT INTO PersonnelStade VALUES (19, 'Lefevre', 'Alexandre', 'Responsable des équipements', 19);
INSERT INTO PersonnelStade VALUES (20, 'Mercier', 'Nathalie', 'Responsable des communications', 20);
...
INSERT INTO PersonnelStade VALUES (23, 'Robert', 'Elise', 'Responsable des communications', 23);
INSERT INTO PersonnelStade VALUES (24, 'Morel', 'Nicolas', 'Agent d entretien', 24);
INSERT INTO PersonnelStade VALUES (25, 'Fournier', 'Caroline', 'Responsable des événements', 25);
INSERT INTO PersonnelStade VALUES (26, 'Lefevre', 'Romain', 'Technicien son et lumière', 26);
...
INSERT INTO PersonnelStade VALUES (29, 'Lemoine', 'Laure', 'Responsable des opérations', 29);
...
group by c.nomClub;
grant select on ClassementTrophees to utiliser1;
...
grant select on AbonnementsActifs to utiliser1;
...
grant select on MoyenneButs to utiliser1;
...
grant select on PlusDeButsMarques to utiliser1;

-- Vue 5 : Affiche le nombre de matchs joués à domicile et à l'extérieur par club.
...
group by c.idclub, c.nomClub;
grant select on MatchJouer to utiliser1;
...
-- Trgger 2 : Un abonné ne peut détenir qu'un seul abonnement actif à la fois pour un même stade.
...
-- Trgger 3 : Un abonné ne peut pas etre supprimer s'il possède un abonnement actif.
...
-- Script SQL qui affiche la liste de toutes les contraintes d'intégrité par table et par type, en incluant le 
-- 	corps de chaque contrainte
create or replace procedure liste_ora_contraintes is
    nbr number := 1
begin
